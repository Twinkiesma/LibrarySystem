    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <h1 class="m-0 text-dark">信息修改</h1>
            </div><!-- /.container-fluid -->
        </div> <!-- /.content-header -->
                ...
                <div class="row">
                    <div class="col">
                        <div class="card card-gray">
                            <!-- form start -->
                            <form action="reader_info_edit_rdo.html" method="post" id="edit" >
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly="readonly" class="form-control" name="type" id="type" value="${readerinfo.type}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <script>
                                                $("#edit").submit(function () {
                                                    if($("#name").val()==''||$("#sex").val()==''||$("#company").val()==''||$("#type").val()==''||$("#level").val()==''){
                                                        alert("请填入完整信息！");
                                                        return false;
                                                    }
                                                })
